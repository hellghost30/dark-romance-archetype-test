  ...
  return (
    <div className="w-full max-w-md mx-auto bg-gray-900 text-white rounded-lg shadow-2xl overflow-hidden p-6">
      ...
      <p className="mt-3 text-gray-300">
        Ти вже майже бачиш повну картину. Залишився один крок.
      </p>
      ...
      <button
        onClick={async () => {
          ...
          // ✅ прибираємо старий invoiceId, щоб не було фантомного polling
          try {
            window.localStorage.removeItem(LAST_INVOICE_KEY);
          } catch {}
      ...
      >
        {isSyncing
          ...
          : isPaying
          ? "Переадресація..."
          : `Відкрити мій результат — ${priceUah} грн`}
      </button>

      <p className="mt-3 text-center text-gray-400 text-sm">
        Оплата відкриває доступ до результату цього тесту
      </p>
